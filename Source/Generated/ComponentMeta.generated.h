...
struct ComponentMeta<CameraTPVControlComponent> {
    ...
    static constexpr auto Fields = std::make_tuple(
        ...
        MakeField("lookAtHeight", &CameraTPVControlComponent::lookAtHeight),
        MakeField("shoulderOffset", &CameraTPVControlComponent::shoulderOffset),
        MakeField("forwardOffset", &CameraTPVControlComponent::forwardOffset),
        MakeField("lookAheadDistance", &CameraTPVControlComponent::lookAheadDistance),
        MakeField("smoothness", &CameraTPVControlComponent::smoothness),
        MakeField("rotationSmoothness", &CameraTPVControlComponent::rotationSmoothness),
        MakeField("pitch", &CameraTPVControlComponent::pitch),
        MakeField("yaw", &CameraTPVControlComponent::yaw),
        MakeField("followTargetFacing", &CameraTPVControlComponent::followTargetFacing),
        MakeField("allowManualOrbit", &CameraTPVControlComponent::allowManualOrbit)
    );
};
...
template <>
struct ComponentMeta<TerrainComponent> {
    static constexpr std::string_view Name = "TerrainComponent";
    static constexpr auto Fields = std::make_tuple(
        MakeField("asset", &TerrainComponent::asset),
        MakeField("needsRebuild", &TerrainComponent::needsRebuild),
        MakeField("needsSplatUpload", &TerrainComponent::needsSplatUpload),
        MakeField("showInEditor", &TerrainComponent::showInEditor)
    );
};

template <>
struct ComponentMeta<GrassComponent> {
    static constexpr std::string_view Name = "GrassComponent";
    static constexpr auto Fields = std::make_tuple(
        MakeField("enabled", &GrassComponent::enabled),
        MakeField("needsRebuild", &GrassComponent::needsRebuild),
        MakeField("layers", &GrassComponent::layers),
        MakeField("windDirection", &GrassComponent::windDirection),
        MakeField("drawDistance", &GrassComponent::drawDistance),
        MakeField("showInEditor", &GrassComponent::showInEditor)
    );
};
