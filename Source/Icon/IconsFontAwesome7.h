// IconFontCppHeaders の GenerateIconFontCppHeaders.py で生成された定義。
// C / C++ から使うための定義。
// Font Awesome 7 の metadata/icons.yml から codepoint を生成している。
// fa-regular-400.woff2 と fa-solid-900.woff2 用。loader によっては .ttf 変換が必要。
